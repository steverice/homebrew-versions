...
class Zookeeper33 < Formula
  homepage 'http://zookeeper.apache.org/'
  url 'http://www.apache.org/dyn/closer.cgi?path=zookeeper/zookeeper-3.3.6/zookeeper-3.3.6.tar.gz'
  sha1 'ea119527974f202c70e463eab28c7a8eeb68bf57'

  head do
    url 'http://svn.apache.org/repos/asf/zookeeper/tags/release-3.3.6'
